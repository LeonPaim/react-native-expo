    ...
    async function getLogin() {
        try {
            ...
            if (dados) {
                ...
                const usuario = clientes.find((c: Cliente) => c.email === email);
                ...
                // Em produção, compare hash da senha
                // Por enquanto, só simulamos login bem-sucedido
                setLoginSuccess(true);

                // Navega para Home após 1.5 segundos
                setTimeout(() => {
